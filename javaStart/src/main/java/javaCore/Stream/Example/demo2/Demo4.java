...
public class Demo4 {
    public static void main(String[] args) throws IOException {
        ...
        //У метода of() имееются аргументы переменной длины, поэому поток данных можно построить
        ...
        //Для создания бесконечных потоков данных в интерфейсе Stream естть два статических метода
